...
export default function Navbar() {
  ...
  const navLink = (to, label) => (
    <Link
      to={to}
      style={{
        color: isActive(to) ? P.red : P.muted,
        textDecoration: "none",
        fontSize: 14,
        fontWeight: isActive(to) ? 700 : 500,
        padding: "6px 14px",
        borderRadius: 8,
        background: isActive(to) ? P.redL : "transparent",
        transition: "all .2s",
      }}
    >
      {label}
  ...
  return (
    <nav style={{
      ...
      borderBottom: `1px solid ${P.warmM}`,
      boxShadow: "0 2px 20px rgba(28,10,6,.06)",
    }}>
      <div style={{
        ...
        <Link to="/" style={{ textDecoration: "none", display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 10, color: P.muted, letterSpacing: 1.2, textTransform: "uppercase" }}>
              Donor Network
            </div>
          </div>
        </Link>
          ...
          {!donor ? (
            <>
              ...
              <Link
                ...
                style={{
                  ...
                  background: isActive("/login") ? P.redL : "transparent",
                  color: isActive("/login") ? P.red : P.muted,
                }}
              >
                Login
              </Link>
            ...
            <>
              ...
              <div style={{
                ...
                borderLeft: `1.5px solid ${P.warmM}`,
              }}>
                <div style={{
                  width: 36, height: 36,
                  background: `linear-gradient(135deg,${P.red},${P.redD})`,
                ...
                <div>
                  <div style={{ fontSize: 13, fontWeight: 700, color: P.dark }}>{donor.name}</div>
                ...
                <button
                  ...
                  style={{
                    ...
                    background: P.warmD, border: `1.5px solid ${P.warmM}`,
